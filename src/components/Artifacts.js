...
const Artifacts = () => {
  ...
  const artifacts = [
    ...
    { Name: "Statis Sphere - Level 6", title: "a combination of hexagonal frames that lock in place when exposed to a current.", description:"Once locked, the heaxgons have to be carefully dismantled. The contents inside are in a temporal statis and cannot be affected by the outside world. The sphere itself is locked spatially relative to the largest mass." },
